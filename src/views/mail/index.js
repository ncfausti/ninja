...
import {
    ...
    Progress, Modal, ModalHeader, ModalBody,
...
const emailLists = [
    {name: 'park.io', subject: 'Selling 40 io domains', summary: 'Lorem ipsum dolar sit amet consector', date: '22nd Dec'},
    {name: 'android.io', subject: 'Calling all android developers to attend a meet', summary: 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered', date: '12th Feb'},
    {name: 'Gray Dark', subject: 'Blackhat SEO tactics to avoid', summary: 'Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid', date: '14th Feb'},
    {name: 'Taptica', subject: 'Monetize your inventory with us', summary: 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni', date: '3 min ago'},
    {name: 'formicon.io', subject: 'Online Form Generator', summary: 'molestias excepturi sint occaecati cupiditate non provident, similique sunt', date: '4 days ago'}
]
        ...
        return (
            <div className="view-mail">
                ...
                <nav className={`email-nav p-4 ${navOpen}`}>
                    ...
                    <button className="btn btn-success btn-block mb-4" onClick={this.toggleModal}>Compose</button>
                    <h6 className="mb-3 small text-muted">Navigation</h6>
                    <ul className="list-unstyled">
                        <li><a href="#na" className="active"><IconInbox size="16"/><span className="text">Inbox</span>&emsp;<span className="badge badge-primary">15</span></a></li>
                        <li><a href="#na"><IconSent size="16"/><span className="text">Sent</span>&emsp;<span className="badge badge-success">3</span></a></li>
                        <li><a href="#na"><IconDraft size="16"/><span className="text">Drafts</span>&emsp;<span className="badge badge-warning">1</span></a></li>
                        <li><a href="#na"><IconChat size="16"/><span className="text">Chats</span></a></li>
                        <li><a href="#na"><IconTrash size="16"/><span className="text">Trash</span></a></li>
                    </ul>
                    <h6 className="mb-3 text-muted small">Labels</h6>
                    <ul className="labels list-unstyled">
                        <li><span className="text">Work</span><IconLabel size="10" color="#f44336"/></li>
                        <li><span className="text">Data</span><IconLabel size="10" color="#1976d2"/></li>
                        <li><span className="text">Clients</span><IconLabel size="10" color="#795548"/></li>
                    </ul>
                </nav>

                <div className="email-content-wrapper">
                    <ul className="email-lists list-unstyled mb-4">
                        {emailLists.map((email, i) => <li key={i}>
                            <a href="#n">
                        ...
                        <div className="card-block">
                            <header className="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <ButtonGroup className="mb-2">
                                        <Button size="sm"><IconTrash size="12"/></Button>
                                        <Button size="sm"><IconBack size="12"/></Button>
                                        <Button size="sm"><IconForward size="12"/></Button>
                                    </ButtonGroup>
                            ...
                            <div className="summary">
                                ...
                                <figure>
                                    ...
                                    <figcaption className="text-muted small">Free Random Image by placeimg.com</figcaption>
                                </figure>
                            ...
                            <div className="mt-2 text-right">
                                <Button color="success"><IconSent size="12"/>&nbsp;Reply</Button>
                            </div>
                        </div>
                    </div>
                </div>
